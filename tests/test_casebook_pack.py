"""Regression checks for the ember-data-partition-mesh casebook."""
...
from casebook.harness import assert_expected, ember_data_partition_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ember_data_partition_mesh_summary(), assert_expected())
